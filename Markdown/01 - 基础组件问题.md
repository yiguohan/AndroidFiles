...
### 7. 两个Activity之间怎么传递数据？intent和bundle有什么区别？为什么有了intent还要设计bundle？
...
### 15. 是否了解ActivityManagerService，它发挥什么作用，说一下AMS启动流程？
...
### 21. 在fragment中为什么有时getActivity()会为null？Fragment视图为什么有的时候会重叠，怎么产生的，又如何解决？
